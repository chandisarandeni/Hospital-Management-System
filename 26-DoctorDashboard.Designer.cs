namespace FinalProjectHMS
{
    partial class DoctorDashboard
    {
        ...
        private void InitializeComponent()
        {
            ...
            label6 = new Label();
            grid_upcommingAppointments = new DataGridView();
            grid_PatientAppointments = new DataGridView();
            label2 = new Label();
            ...
            ((System.ComponentModel.ISupportInitialize)grid_upcommingAppointments).BeginInit();
            ((System.ComponentModel.ISupportInitialize)grid_PatientAppointments).BeginInit();
            SuspendLayout();
            // 
            // sidebarTimer
            // 
            ...
            label6.Location = new Point(346, 157);
            label6.Name = "label6";
            label6.Size = new Size(191, 19);
            label6.TabIndex = 95;
            label6.Text = "Upcoming Appointments";
            // 
            // grid_upcommingAppointments
            // 
            grid_upcommingAppointments.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            grid_upcommingAppointments.Location = new Point(346, 189);
            grid_upcommingAppointments.Margin = new Padding(3, 4, 3, 4);
            grid_upcommingAppointments.Name = "grid_upcommingAppointments";
            grid_upcommingAppointments.RowHeadersWidth = 51;
            grid_upcommingAppointments.Size = new Size(367, 523);
            grid_upcommingAppointments.TabIndex = 94;
            // 
            // grid_PatientAppointments
            // 
            grid_PatientAppointments.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            grid_PatientAppointments.Location = new Point(778, 189);
            grid_PatientAppointments.Margin = new Padding(3, 4, 3, 4);
            grid_PatientAppointments.Name = "grid_PatientAppointments";
            grid_PatientAppointments.RowHeadersWidth = 51;
            grid_PatientAppointments.Size = new Size(367, 523);
            grid_PatientAppointments.TabIndex = 94;
            // 
            // label2
            // 
            label2.AutoSize = true;
            label2.Font = new Font("Times New Roman", 9.75F, FontStyle.Bold, GraphicsUnit.Point, 0);
            label2.Location = new Point(778, 157);
            label2.Name = "label2";
            label2.Size = new Size(387, 19);
            label2.TabIndex = 95;
            label2.Text = "Recently Checked Patinets and Their Prescriptions\r\n";
            // 
            // DoctorDashboard
            // 
            ...
            Controls.Add(label2);
            Controls.Add(grid_PatientAppointments);
            Controls.Add(label6);
            Controls.Add(grid_upcommingAppointments);
            ...
            ((System.ComponentModel.ISupportInitialize)grid_upcommingAppointments).EndInit();
            ((System.ComponentModel.ISupportInitialize)grid_PatientAppointments).EndInit();
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private DataGridView grid_upcommingAppointments;
        private DataGridView grid_PatientAppointments;
