...
{
    public partial class DocForgotPassword : Form
    {
        public DocForgotPassword()
        {
            InitializeComponent();
        }
        ...
        {
            DocForgotPassword forgotPassword = new DocForgotPassword();
            forgotPassword.Show();
            this.Hide();
        }
        ...
        private void btn_Submit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    string stm = "SELECT NIC, SecretPin FROM DoctorDetails WHERE NIC = @NIC AND SecretPin = @SecretPin";
