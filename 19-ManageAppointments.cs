                    ...
                    using (SqlCommand cmd = new SqlCommand(stm, con))
                    {
                        ...
                        using (SqlDataReader reader = cmd.ExecuteReader())
                        {
                            if (reader.Read())
                            {
                                ...
                                lbl_showPatientMobile.Text = ((DateTime)reader["Birthday"]).ToShortDateString();
                                ...
                                {
                                    conn1.Open();
                                    string query1 = "SELECT AppointmentNumber,PatientName, NIC, DoctorName, AppointmentDate FROM appointmentAndPrescriptions WHERE NIC = @NIC";
                                    using (SqlCommand cmd1 = new SqlCommand(query1, conn1))
                                    {
                                        ...
                                        using (SqlDataReader reader1 = cmd1.ExecuteReader())
                                        {
                                            ...
                                            grid_placedAppointments.DataSource = table1;
                                        }
                                    }
